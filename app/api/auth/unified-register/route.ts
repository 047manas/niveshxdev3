...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        if (userType === 'founder') {
            const { companyName, companyWebsite, contactEmail } = formData;
        ...
        // Step 2: All validation passed. Create Auth user.
        ...
        // Step 3: Create all Firestore documents in a single atomic batch
